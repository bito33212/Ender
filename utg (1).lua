...
minimizeButton.BackgroundColor3 = Color3.fromRGB(0, 0, 200)
...
minimizeButton.MouseButton1Click:Connect(function()
    mainFrame.Size = isMinimized and UDim2.new(0, 700, 0, 70) or UDim2.new(0, 700, 0, 900)
...
local tabFrames = {}
local tabNames = {"Scripts", "requires", "destruction", "reanimation"}
...
createButton("Sin Dragon", "https://raw.githubusercontent.com/gObl00x/Pendulum-Fixed-AND-Others-Scripts/refs/heads/main/Sin%20Dragon", "", tabFrames["Scripts"])
...
createButton("Serveradmin", "https://raw.githubusercontent.com/gObl00x/Pendulum-Fixed-AND-Others-Scripts/refs/heads/main/Server%20Admin", "78534559289195", tabFrames["requires"])
...
-- Pack 3 (Server Des-)
createButton("C00lGui", "https://raw.githubusercontent.com/nicolasbarbosa323/c00lgui/refs/heads/main/c00lguiv3rx.lua.txt", "", tabFrames["destruction"])
createButton("RO-xploit", "https://rawscripts.net/raw/Universal-Script-ro-xploit-6-9233", "", tabFrames["destruction"])